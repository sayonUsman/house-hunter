const Contact = () => {
  return (
    <div className="container my-16 lg:my-20 mx-auto">
          ...
          <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="mx-auto mb-12 text-center lg:mb-0">
              <svg
                ...
                strokeWidth="2"
                stroke="currentColor"
                className="mx-auto mb-6 h-8 w-8 text-white"
              >
                <path
                  strokeLinecap="round"
            ...
            <div className="mx-auto mb-6 text-center md:mb-0">
              ...
              <h6 className="font-medium">+ 880 123 456 7890</h6>
            </div>
          ...
          <div className="mx-auto max-w-[700px]">
            <form>
              <div className="relative mb-6" data-te-input-wrapper-init>
                <input
                  type="text"
                  className="w-full h-10 bg-transparent border-b border-white outline-none"
                  placeholder="Name"
                />
              </div>
              ...
              <div className="mb-6 inline-block min-h-[1.5rem] justify-center pl-[1.5rem] md:flex">
                ...
                <label className="pl-1">Send me a copy of this message</label>
              </div>

              <button
                type="button"
                className="btn w-full rounded bg-transparent hover:bg-transparent text-white border border-white hover:border-white"
              >
                Send
              </button>
            </form>
